...
# Hebo API Docker Deployment Script
...
echo "🚀 Starting Hebo API deployment to AWS ECR Public..."
...
cd ../../ && docker build -t ${LOCAL_IMAGE_NAME}:${IMAGE_TAG} -f apps/api/Dockerfile .
